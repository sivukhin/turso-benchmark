"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([["vendors-node_modules_codemirror_lang-cpp_dist_index_js-node_modules_codemirror_lang-javascrip-c52275"],{
    ...
    return Object.assign(Object.assign({}, state.changeByRange(range => {
        if (range == state.selection.main)
            return {
                ...
                range: _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(from + text.length)
            };
        let len = to - from;
        if (!range.empty ||
...
class FuzzyMatcher {
    ...
    match(word) {
        ...
        // at the start
        if (chars.length == 1) {
            let first = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(word, 0);
            return first == chars[0] ? [0, 0, (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(first)]
                : first == folded[0] ? [-200 /* CaseFold */, 0, (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(first)] : null;
        }
...
class CompletionTooltip {
    ...
    measureInfo() {
        ...
        let left = this.view.textDirection == _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Direction.RTL;
...
function handleSame(state, token, allowTriple) {
    let dont = null, changes = state.changeByRange(range => {
        ...
        if (next == token) {
            ...
            if (prev != token && state.charCategorizer(pos)(prev) != _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Word && !probablyInString(state, pos, token))
                return { changes: { insert: token + token, from: pos },
                    effects: closeBracketEffect.of(pos + token.length),
                    range: _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(pos + token.length) };
        }
...
function getScope(doc, node) {
    ...
    node.cursor(_lezer_common__WEBPACK_IMPORTED_MODULE_5__.IterMode.IncludeAnonymous).iterate(node => {
        if (top) {
            top = false;
        }
        else if (node.name) {
...
//# sourceMappingURL=vendors-node_modules_codemirror_lang-cpp_dist_index_js-node_modules_codemirror_lang-javascrip-c52275.d1ac6a17807b9b7613d1.bundle.js.map