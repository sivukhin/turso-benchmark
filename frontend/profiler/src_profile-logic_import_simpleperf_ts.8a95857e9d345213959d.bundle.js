"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([["src_profile-logic_import_simpleperf_ts"],{

/***/ "./src/profile-logic/import/proto/simpleperf_report.js":
/*!*************************************************************!*\
  !*** ./src/profile-logic/import/proto/simpleperf_report.js ***!
  \*************************************************************/
...
$root.simpleperf_report_proto = function () {
  ...
  simpleperf_report_proto.Sample = function () {
    ...
    Sample.encode = function encode(message, writer) {
      ...
      if (message.time != null && Object.hasOwnProperty.call(message, "time")) writer.uint32(/* id 1, wireType 0 =*/8).uint64(message.time);
      if (message.threadId != null && Object.hasOwnProperty.call(message, "threadId")) writer.uint32(/* id 2, wireType 0 =*/16).int32(message.threadId);
      if (message.callchain != null && message.callchain.length) for (var i = 0; i < message.callchain.length; ++i) $root.simpleperf_report_proto.Sample.CallChainEntry.encode(message.callchain[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
      if (message.eventCount != null && Object.hasOwnProperty.call(message, "eventCount")) writer.uint32(/* id 4, wireType 0 =*/32).uint64(message.eventCount);
      if (message.eventTypeId != null && Object.hasOwnProperty.call(message, "eventTypeId")) writer.uint32(/* id 5, wireType 0 =*/40).uint32(message.eventTypeId);
      if (message.unwindingResult != null && Object.hasOwnProperty.call(message, "unwindingResult")) $root.simpleperf_report_proto.Sample.UnwindingResult.encode(message.unwindingResult, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
      return writer;
    };
    ...
    Sample.decode = function decode(reader, length, error) {
      ...
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.simpleperf_report_proto.Sample();
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3:
            {
              if (!(message.callchain && message.callchain.length)) message.callchain = [];
    ...
    Sample.verify = function verify(message) {
      ...
      if (message.threadId != null && message.hasOwnProperty("threadId")) if (!$util.isInteger(message.threadId)) return "threadId: integer expected";
      if (message.callchain != null && message.hasOwnProperty("callchain")) {
        if (!Array.isArray(message.callchain)) return "callchain: array expected";
        for (var i = 0; i < message.callchain.length; ++i) {
          ...
          if (error) return "callchain." + error;
        }
      }
      if (message.eventCount != null && message.hasOwnProperty("eventCount")) if (!$util.isInteger(message.eventCount) && !(message.eventCount && $util.isInteger(message.eventCount.low) && $util.isInteger(message.eventCount.high))) return "eventCount: integer|Long expected";
      if (message.eventTypeId != null && message.hasOwnProperty("eventTypeId")) if (!$util.isInteger(message.eventTypeId)) return "eventTypeId: integer expected";
      if (message.unwindingResult != null && message.hasOwnProperty("unwindingResult")) {
        ...
        if (error) return "unwindingResult." + error;
      }
      return null;
    };
    ...
    Sample.fromObject = function fromObject(object) {
      if (object instanceof $root.simpleperf_report_proto.Sample) return object;
      var message = new $root.simpleperf_report_proto.Sample();
      if (object.time != null) if ($util.Long) (message.time = $util.Long.fromValue(object.time)).unsigned = true;else if (typeof object.time === "string") message.time = parseInt(object.time, 10);else if (typeof object.time === "number") message.time = object.time;else if (typeof object.time === "object") message.time = new $util.LongBits(object.time.low >>> 0, object.time.high >>> 0).toNumber(true);
      if (object.threadId != null) message.threadId = object.threadId | 0;
      if (object.callchain) {
        if (!Array.isArray(object.callchain)) throw TypeError(".simpleperf_report_proto.Sample.callchain: array expected");
        message.callchain = [];
        for (var i = 0; i < object.callchain.length; ++i) {
          if (typeof object.callchain[i] !== "object") throw TypeError(".simpleperf_report_proto.Sample.callchain: object expected");
          message.callchain[i] = $root.simpleperf_report_proto.Sample.CallChainEntry.fromObject(object.callchain[i]);
        }
      }
      if (object.eventCount != null) if ($util.Long) (message.eventCount = $util.Long.fromValue(object.eventCount)).unsigned = true;else if (typeof object.eventCount === "string") message.eventCount = parseInt(object.eventCount, 10);else if (typeof object.eventCount === "number") message.eventCount = object.eventCount;else if (typeof object.eventCount === "object") message.eventCount = new $util.LongBits(object.eventCount.low >>> 0, object.eventCount.high >>> 0).toNumber(true);
      if (object.eventTypeId != null) message.eventTypeId = object.eventTypeId >>> 0;
      if (object.unwindingResult != null) {
        if (typeof object.unwindingResult !== "object") throw TypeError(".simpleperf_report_proto.Sample.unwindingResult: object expected");
    ...
    Sample.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.arrays || options.defaults) object.callchain = [];
      if (options.defaults) {
        if ($util.Long) {
        ...
        } else object.eventCount = options.longs === String ? "0" : 0;
        object.eventTypeId = 0;
        object.unwindingResult = null;
      }
      if (message.time != null && message.hasOwnProperty("time")) if (typeof message.time === "number") object.time = options.longs === String ? String(message.time) : message.time;else object.time = options.longs === String ? $util.Long.prototype.toString.call(message.time) : options.longs === Number ? new $util.LongBits(message.time.low >>> 0, message.time.high >>> 0).toNumber(true) : message.time;
      if (message.threadId != null && message.hasOwnProperty("threadId")) object.threadId = message.threadId;
      if (message.callchain && message.callchain.length) {
        object.callchain = [];
        for (var j = 0; j < message.callchain.length; ++j) object.callchain[j] = $root.simpleperf_report_proto.Sample.CallChainEntry.toObject(message.callchain[j], options);
      }
      if (message.eventCount != null && message.hasOwnProperty("eventCount")) if (typeof message.eventCount === "number") object.eventCount = options.longs === String ? String(message.eventCount) : message.eventCount;else object.eventCount = options.longs === String ? $util.Long.prototype.toString.call(message.eventCount) : options.longs === Number ? new $util.LongBits(message.eventCount.low >>> 0, message.eventCount.high >>> 0).toNumber(true) : message.eventCount;
      if (message.eventTypeId != null && message.hasOwnProperty("eventTypeId")) object.eventTypeId = message.eventTypeId;
      if (message.unwindingResult != null && message.hasOwnProperty("unwindingResult")) object.unwindingResult = $root.simpleperf_report_proto.Sample.UnwindingResult.toObject(message.unwindingResult, options);
      return object;
    };
    ...
    Sample.CallChainEntry = function () {
      ...
      CallChainEntry.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.vaddrInFile != null && Object.hasOwnProperty.call(message, "vaddrInFile")) writer.uint32(/* id 1, wireType 0 =*/8).uint64(message.vaddrInFile);
        if (message.fileId != null && Object.hasOwnProperty.call(message, "fileId")) writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.fileId);
        if (message.symbolId != null && Object.hasOwnProperty.call(message, "symbolId")) writer.uint32(/* id 3, wireType 0 =*/24).int32(message.symbolId);
        if (message.executionType != null && Object.hasOwnProperty.call(message, "executionType")) writer.uint32(/* id 4, wireType 0 =*/32).int32(message.executionType);
        return writer;
      };
      ...
      CallChainEntry.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.simpleperf_report_proto.Sample.CallChainEntry();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      CallChainEntry.verify = function verify(message) {
        if (typeof message !== "object" || message === null) return "object expected";
        if (message.vaddrInFile != null && message.hasOwnProperty("vaddrInFile")) if (!$util.isInteger(message.vaddrInFile) && !(message.vaddrInFile && $util.isInteger(message.vaddrInFile.low) && $util.isInteger(message.vaddrInFile.high))) return "vaddrInFile: integer|Long expected";
        if (message.fileId != null && message.hasOwnProperty("fileId")) if (!$util.isInteger(message.fileId)) return "fileId: integer expected";
        if (message.symbolId != null && message.hasOwnProperty("symbolId")) if (!$util.isInteger(message.symbolId)) return "symbolId: integer expected";
        if (message.executionType != null && message.hasOwnProperty("executionType")) switch (message.executionType) {
          default:
    ...
    Sample.UnwindingResult = function () {
      ...
      UnwindingResult.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.rawErrorCode != null && Object.hasOwnProperty.call(message, "rawErrorCode")) writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.rawErrorCode);
        if (message.errorAddr != null && Object.hasOwnProperty.call(message, "errorAddr")) writer.uint32(/* id 2, wireType 0 =*/16).uint64(message.errorAddr);
        if (message.errorCode != null && Object.hasOwnProperty.call(message, "errorCode")) writer.uint32(/* id 3, wireType 0 =*/24).int32(message.errorCode);
        return writer;
      };
      ...
      UnwindingResult.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.simpleperf_report_proto.Sample.UnwindingResult();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      UnwindingResult.verify = function verify(message) {
        if (typeof message !== "object" || message === null) return "object expected";
        if (message.rawErrorCode != null && message.hasOwnProperty("rawErrorCode")) if (!$util.isInteger(message.rawErrorCode)) return "rawErrorCode: integer expected";
        if (message.errorAddr != null && message.hasOwnProperty("errorAddr")) if (!$util.isInteger(message.errorAddr) && !(message.errorAddr && $util.isInteger(message.errorAddr.low) && $util.isInteger(message.errorAddr.high))) return "errorAddr: integer|Long expected";
        if (message.errorCode != null && message.hasOwnProperty("errorCode")) switch (message.errorCode) {
          default:
      ...
      UnwindingResult.fromObject = function fromObject(object) {
        if (object instanceof $root.simpleperf_report_proto.Sample.UnwindingResult) return object;
        var message = new $root.simpleperf_report_proto.Sample.UnwindingResult();
        if (object.rawErrorCode != null) message.rawErrorCode = object.rawErrorCode >>> 0;
        if (object.errorAddr != null) if ($util.Long) (message.errorAddr = $util.Long.fromValue(object.errorAddr)).unsigned = true;else if (typeof object.errorAddr === "string") message.errorAddr = parseInt(object.errorAddr, 10);else if (typeof object.errorAddr === "number") message.errorAddr = object.errorAddr;else if (typeof object.errorAddr === "object") message.errorAddr = new $util.LongBits(object.errorAddr.low >>> 0, object.errorAddr.high >>> 0).toNumber(true);
      ...
      UnwindingResult.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
          ...
          } else object.errorAddr = options.longs === String ? "0" : 0;
          object.errorCode = options.enums === String ? "ERROR_NONE" : 0;
        }
        if (message.rawErrorCode != null && message.hasOwnProperty("rawErrorCode")) object.rawErrorCode = message.rawErrorCode;
        if (message.errorAddr != null && message.hasOwnProperty("errorAddr")) if (typeof message.errorAddr === "number") object.errorAddr = options.longs === String ? String(message.errorAddr) : message.errorAddr;else object.errorAddr = options.longs === String ? $util.Long.prototype.toString.call(message.errorAddr) : options.longs === Number ? new $util.LongBits(message.errorAddr.low >>> 0, message.errorAddr.high >>> 0).toNumber(true) : message.errorAddr;
  ...
  simpleperf_report_proto.LostSituation = function () {
    ...
    LostSituation.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.sampleCount != null && Object.hasOwnProperty.call(message, "sampleCount")) writer.uint32(/* id 1, wireType 0 =*/8).uint64(message.sampleCount);
      if (message.lostCount != null && Object.hasOwnProperty.call(message, "lostCount")) writer.uint32(/* id 2, wireType 0 =*/16).uint64(message.lostCount);
      return writer;
    };
    ...
    LostSituation.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.simpleperf_report_proto.LostSituation();
      while (reader.pos < end) {
        var tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    LostSituation.verify = function verify(message) {
      if (typeof message !== "object" || message === null) return "object expected";
      if (message.sampleCount != null && message.hasOwnProperty("sampleCount")) if (!$util.isInteger(message.sampleCount) && !(message.sampleCount && $util.isInteger(message.sampleCount.low) && $util.isInteger(message.sampleCount.high))) return "sampleCount: integer|Long expected";
      if (message.lostCount != null && message.hasOwnProperty("lostCount")) if (!$util.isInteger(message.lostCount) && !(message.lostCount && $util.isInteger(message.lostCount.low) && $util.isInteger(message.lostCount.high))) return "lostCount: integer|Long expected";
      return null;
    };
    ...
    LostSituation.fromObject = function fromObject(object) {
      if (object instanceof $root.simpleperf_report_proto.LostSituation) return object;
      var message = new $root.simpleperf_report_proto.LostSituation();
      if (object.sampleCount != null) if ($util.Long) (message.sampleCount = $util.Long.fromValue(object.sampleCount)).unsigned = true;else if (typeof object.sampleCount === "string") message.sampleCount = parseInt(object.sampleCount, 10);else if (typeof object.sampleCount === "number") message.sampleCount = object.sampleCount;else if (typeof object.sampleCount === "object") message.sampleCount = new $util.LongBits(object.sampleCount.low >>> 0, object.sampleCount.high >>> 0).toNumber(true);
      if (object.lostCount != null) if ($util.Long) (message.lostCount = $util.Long.fromValue(object.lostCount)).unsigned = true;else if (typeof object.lostCount === "string") message.lostCount = parseInt(object.lostCount, 10);else if (typeof object.lostCount === "number") message.lostCount = object.lostCount;else if (typeof object.lostCount === "object") message.lostCount = new $util.LongBits(object.lostCount.low >>> 0, object.lostCount.high >>> 0).toNumber(true);
      return message;
    };
    ...
    LostSituation.toObject = function toObject(message, options) {
      ...
      if (options.defaults) {
        ...
        } else object.sampleCount = options.longs === String ? "0" : 0;
        if ($util.Long) {
          var long = new $util.Long(0, 0, true);
          object.lostCount = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
        } else object.lostCount = options.longs === String ? "0" : 0;
      }
      if (message.sampleCount != null && message.hasOwnProperty("sampleCount")) if (typeof message.sampleCount === "number") object.sampleCount = options.longs === String ? String(message.sampleCount) : message.sampleCount;else object.sampleCount = options.longs === String ? $util.Long.prototype.toString.call(message.sampleCount) : options.longs === Number ? new $util.LongBits(message.sampleCount.low >>> 0, message.sampleCount.high >>> 0).toNumber(true) : message.sampleCount;
      if (message.lostCount != null && message.hasOwnProperty("lostCount")) if (typeof message.lostCount === "number") object.lostCount = options.longs === String ? String(message.lostCount) : message.lostCount;else object.lostCount = options.longs === String ? $util.Long.prototype.toString.call(message.lostCount) : options.longs === Number ? new $util.LongBits(message.lostCount.low >>> 0, message.lostCount.high >>> 0).toNumber(true) : message.lostCount;
      return object;
    };
  ...
  simpleperf_report_proto.File = function () {
    ...
    File.encode = function encode(message, writer) {
      ...
      if (message.symbol != null && message.symbol.length) for (var i = 0; i < message.symbol.length; ++i) writer.uint32(/* id 3, wireType 2 =*/26).string(message.symbol[i]);
      if (message.mangledSymbol != null && message.mangledSymbol.length) for (var i = 0; i < message.mangledSymbol.length; ++i) writer.uint32(/* id 4, wireType 2 =*/34).string(message.mangledSymbol[i]);
      return writer;
    };
    ...
    File.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.simpleperf_report_proto.File();
      while (reader.pos < end) {
        var tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
          ...
          case 4:
            {
              if (!(message.mangledSymbol && message.mangledSymbol.length)) message.mangledSymbol = [];
    ...
    File.verify = function verify(message) {
      ...
      if (message.symbol != null && message.hasOwnProperty("symbol")) {
        ...
        for (var i = 0; i < message.symbol.length; ++i) if (!$util.isString(message.symbol[i])) return "symbol: string[] expected";
      }
      if (message.mangledSymbol != null && message.hasOwnProperty("mangledSymbol")) {
        if (!Array.isArray(message.mangledSymbol)) return "mangledSymbol: array expected";
        for (var i = 0; i < message.mangledSymbol.length; ++i) if (!$util.isString(message.mangledSymbol[i])) return "mangledSymbol: string[] expected";
      }
      return null;
    };
    ...
    File.fromObject = function fromObject(object) {
      if (object instanceof $root.simpleperf_report_proto.File) return object;
      var message = new $root.simpleperf_report_proto.File();
      if (object.id != null) message.id = object.id >>> 0;
      if (object.path != null) message.path = String(object.path);
      if (object.symbol) {
        if (!Array.isArray(object.symbol)) throw TypeError(".simpleperf_report_proto.File.symbol: array expected");
        message.symbol = [];
        for (var i = 0; i < object.symbol.length; ++i) message.symbol[i] = String(object.symbol[i]);
      }
      if (object.mangledSymbol) {
        if (!Array.isArray(object.mangledSymbol)) throw TypeError(".simpleperf_report_proto.File.mangledSymbol: array expected");
        message.mangledSymbol = [];
        for (var i = 0; i < object.mangledSymbol.length; ++i) message.mangledSymbol[i] = String(object.mangledSymbol[i]);
      }
      return message;
    };
    ...
    File.toObject = function toObject(message, options) {
      ...
      if (message.symbol && message.symbol.length) {
        object.symbol = [];
        for (var j = 0; j < message.symbol.length; ++j) object.symbol[j] = message.symbol[j];
      }
      if (message.mangledSymbol && message.mangledSymbol.length) {
        object.mangledSymbol = [];
        for (var j = 0; j < message.mangledSymbol.length; ++j) object.mangledSymbol[j] = message.mangledSymbol[j];
      }
      return object;
    };
  ...
  simpleperf_report_proto.Thread = function () {
    ...
    Thread.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.threadId != null && Object.hasOwnProperty.call(message, "threadId")) writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.threadId);
      if (message.processId != null && Object.hasOwnProperty.call(message, "processId")) writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.processId);
      if (message.threadName != null && Object.hasOwnProperty.call(message, "threadName")) writer.uint32(/* id 3, wireType 2 =*/26).string(message.threadName);
      return writer;
    };
    ...
    Thread.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.simpleperf_report_proto.Thread();
      while (reader.pos < end) {
        var tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    Thread.verify = function verify(message) {
      if (typeof message !== "object" || message === null) return "object expected";
      if (message.threadId != null && message.hasOwnProperty("threadId")) if (!$util.isInteger(message.threadId)) return "threadId: integer expected";
      if (message.processId != null && message.hasOwnProperty("processId")) if (!$util.isInteger(message.processId)) return "processId: integer expected";
      if (message.threadName != null && message.hasOwnProperty("threadName")) if (!$util.isString(message.threadName)) return "threadName: string expected";
      return null;
    };
    ...
    Thread.fromObject = function fromObject(object) {
      if (object instanceof $root.simpleperf_report_proto.Thread) return object;
      var message = new $root.simpleperf_report_proto.Thread();
      if (object.threadId != null) message.threadId = object.threadId >>> 0;
      if (object.processId != null) message.processId = object.processId >>> 0;
      if (object.threadName != null) message.threadName = String(object.threadName);
      return message;
    };
    ...
    Thread.toObject = function toObject(message, options) {
      ...
      if (message.threadId != null && message.hasOwnProperty("threadId")) object.threadId = message.threadId;
      if (message.processId != null && message.hasOwnProperty("processId")) object.processId = message.processId;
      if (message.threadName != null && message.hasOwnProperty("threadName")) object.threadName = message.threadName;
      return object;
    };
  ...
  simpleperf_report_proto.MetaInfo = function () {
    ...
    MetaInfo.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.eventType != null && message.eventType.length) for (var i = 0; i < message.eventType.length; ++i) writer.uint32(/* id 1, wireType 2 =*/10).string(message.eventType[i]);
      if (message.appPackageName != null && Object.hasOwnProperty.call(message, "appPackageName")) writer.uint32(/* id 2, wireType 2 =*/18).string(message.appPackageName);
      if (message.appType != null && Object.hasOwnProperty.call(message, "appType")) writer.uint32(/* id 3, wireType 2 =*/26).string(message.appType);
      if (message.androidSdkVersion != null && Object.hasOwnProperty.call(message, "androidSdkVersion")) writer.uint32(/* id 4, wireType 2 =*/34).string(message.androidSdkVersion);
      if (message.androidBuildType != null && Object.hasOwnProperty.call(message, "androidBuildType")) writer.uint32(/* id 5, wireType 2 =*/42).string(message.androidBuildType);
      if (message.traceOffcpu != null && Object.hasOwnProperty.call(message, "traceOffcpu")) writer.uint32(/* id 6, wireType 0 =*/48).bool(message.traceOffcpu);
      return writer;
    };
    ...
    MetaInfo.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.simpleperf_report_proto.MetaInfo();
      while (reader.pos < end) {
        var tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
          case 1:
            {
              if (!(message.eventType && message.eventType.length)) message.eventType = [];
    ...
    MetaInfo.verify = function verify(message) {
      ...
      if (message.eventType != null && message.hasOwnProperty("eventType")) {
        if (!Array.isArray(message.eventType)) return "eventType: array expected";
        for (var i = 0; i < message.eventType.length; ++i) if (!$util.isString(message.eventType[i])) return "eventType: string[] expected";
      }
      if (message.appPackageName != null && message.hasOwnProperty("appPackageName")) if (!$util.isString(message.appPackageName)) return "appPackageName: string expected";
      if (message.appType != null && message.hasOwnProperty("appType")) if (!$util.isString(message.appType)) return "appType: string expected";
      if (message.androidSdkVersion != null && message.hasOwnProperty("androidSdkVersion")) if (!$util.isString(message.androidSdkVersion)) return "androidSdkVersion: string expected";
      if (message.androidBuildType != null && message.hasOwnProperty("androidBuildType")) if (!$util.isString(message.androidBuildType)) return "androidBuildType: string expected";
      if (message.traceOffcpu != null && message.hasOwnProperty("traceOffcpu")) if (typeof message.traceOffcpu !== "boolean") return "traceOffcpu: boolean expected";
      return null;
    };
    ...
    MetaInfo.fromObject = function fromObject(object) {
      if (object instanceof $root.simpleperf_report_proto.MetaInfo) return object;
      var message = new $root.simpleperf_report_proto.MetaInfo();
      if (object.eventType) {
        if (!Array.isArray(object.eventType)) throw TypeError(".simpleperf_report_proto.MetaInfo.eventType: array expected");
        message.eventType = [];
        for (var i = 0; i < object.eventType.length; ++i) message.eventType[i] = String(object.eventType[i]);
      }
      if (object.appPackageName != null) message.appPackageName = String(object.appPackageName);
      if (object.appType != null) message.appType = String(object.appType);
      if (object.androidSdkVersion != null) message.androidSdkVersion = String(object.androidSdkVersion);
      if (object.androidBuildType != null) message.androidBuildType = String(object.androidBuildType);
      if (object.traceOffcpu != null) message.traceOffcpu = Boolean(object.traceOffcpu);
      return message;
    };
    ...
    MetaInfo.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.arrays || options.defaults) object.eventType = [];
      if (options.defaults) {
      ...
      if (message.eventType && message.eventType.length) {
        object.eventType = [];
        for (var j = 0; j < message.eventType.length; ++j) object.eventType[j] = message.eventType[j];
      }
      if (message.appPackageName != null && message.hasOwnProperty("appPackageName")) object.appPackageName = message.appPackageName;
      if (message.appType != null && message.hasOwnProperty("appType")) object.appType = message.appType;
      if (message.androidSdkVersion != null && message.hasOwnProperty("androidSdkVersion")) object.androidSdkVersion = message.androidSdkVersion;
      if (message.androidBuildType != null && message.hasOwnProperty("androidBuildType")) object.androidBuildType = message.androidBuildType;
      if (message.traceOffcpu != null && message.hasOwnProperty("traceOffcpu")) object.traceOffcpu = message.traceOffcpu;
      return object;
    };
  ...
  simpleperf_report_proto.ContextSwitch = function () {
    ...
    ContextSwitch.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.switchOn != null && Object.hasOwnProperty.call(message, "switchOn")) writer.uint32(/* id 1, wireType 0 =*/8).bool(message.switchOn);
      if (message.time != null && Object.hasOwnProperty.call(message, "time")) writer.uint32(/* id 2, wireType 0 =*/16).uint64(message.time);
      if (message.threadId != null && Object.hasOwnProperty.call(message, "threadId")) writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.threadId);
      return writer;
    };
    ...
    ContextSwitch.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.simpleperf_report_proto.ContextSwitch();
      while (reader.pos < end) {
        var tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    ContextSwitch.verify = function verify(message) {
      if (typeof message !== "object" || message === null) return "object expected";
      if (message.switchOn != null && message.hasOwnProperty("switchOn")) if (typeof message.switchOn !== "boolean") return "switchOn: boolean expected";
      if (message.time != null && message.hasOwnProperty("time")) if (!$util.isInteger(message.time) && !(message.time && $util.isInteger(message.time.low) && $util.isInteger(message.time.high))) return "time: integer|Long expected";
      if (message.threadId != null && message.hasOwnProperty("threadId")) if (!$util.isInteger(message.threadId)) return "threadId: integer expected";
      return null;
    };
    ...
    ContextSwitch.fromObject = function fromObject(object) {
      if (object instanceof $root.simpleperf_report_proto.ContextSwitch) return object;
      var message = new $root.simpleperf_report_proto.ContextSwitch();
      if (object.switchOn != null) message.switchOn = Boolean(object.switchOn);
      if (object.time != null) if ($util.Long) (message.time = $util.Long.fromValue(object.time)).unsigned = true;else if (typeof object.time === "string") message.time = parseInt(object.time, 10);else if (typeof object.time === "number") message.time = object.time;else if (typeof object.time === "object") message.time = new $util.LongBits(object.time.low >>> 0, object.time.high >>> 0).toNumber(true);
      if (object.threadId != null) message.threadId = object.threadId >>> 0;
      return message;
    };
    ...
    ContextSwitch.toObject = function toObject(message, options) {
      ...
      if (message.switchOn != null && message.hasOwnProperty("switchOn")) object.switchOn = message.switchOn;
      if (message.time != null && message.hasOwnProperty("time")) if (typeof message.time === "number") object.time = options.longs === String ? String(message.time) : message.time;else object.time = options.longs === String ? $util.Long.prototype.toString.call(message.time) : options.longs === Number ? new $util.LongBits(message.time.low >>> 0, message.time.high >>> 0).toNumber(true) : message.time;
      if (message.threadId != null && message.hasOwnProperty("threadId")) object.threadId = message.threadId;
      return object;
    };
  ...
  simpleperf_report_proto.Record = function () {
    ...
    Record.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.sample != null && Object.hasOwnProperty.call(message, "sample")) $root.simpleperf_report_proto.Sample.encode(message.sample, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
      if (message.lost != null && Object.hasOwnProperty.call(message, "lost")) $root.simpleperf_report_proto.LostSituation.encode(message.lost, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
      if (message.file != null && Object.hasOwnProperty.call(message, "file")) $root.simpleperf_report_proto.File.encode(message.file, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
      if (message.thread != null && Object.hasOwnProperty.call(message, "thread")) $root.simpleperf_report_proto.Thread.encode(message.thread, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
      if (message.metaInfo != null && Object.hasOwnProperty.call(message, "metaInfo")) $root.simpleperf_report_proto.MetaInfo.encode(message.metaInfo, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
      if (message.contextSwitch != null && Object.hasOwnProperty.call(message, "contextSwitch")) $root.simpleperf_report_proto.ContextSwitch.encode(message.contextSwitch, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
      return writer;
    };
    ...
    Record.decode = function decode(reader, length, error) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.simpleperf_report_proto.Record();
      while (reader.pos < end) {
        var tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
    ...
    Record.verify = function verify(message) {
      ...
      if (message.lost != null && message.hasOwnProperty("lost")) {
        if (properties.recordData === 1) return "recordData: multiple values";
        properties.recordData = 1;
        {
          var error = $root.simpleperf_report_proto.LostSituation.verify(message.lost);
          if (error) return "lost." + error;
        }
      }
      ...
      if (message.metaInfo != null && message.hasOwnProperty("metaInfo")) {
        ...
        properties.recordData = 1;
        {
          ...
          if (error) return "metaInfo." + error;
        }
      }
      if (message.contextSwitch != null && message.hasOwnProperty("contextSwitch")) {
        ...
        properties.recordData = 1;
        {
          ...
          if (error) return "contextSwitch." + error;
        }
      }
      return null;
    };
    ...
    Record.fromObject = function fromObject(object) {
      if (object instanceof $root.simpleperf_report_proto.Record) return object;
      var message = new $root.simpleperf_report_proto.Record();
      if (object.sample != null) {
        if (typeof object.sample !== "object") throw TypeError(".simpleperf_report_proto.Record.sample: object expected");
        message.sample = $root.simpleperf_report_proto.Sample.fromObject(object.sample);
      }
      if (object.lost != null) {
        if (typeof object.lost !== "object") throw TypeError(".simpleperf_report_proto.Record.lost: object expected");
        message.lost = $root.simpleperf_report_proto.LostSituation.fromObject(object.lost);
      }
      if (object.file != null) {
        if (typeof object.file !== "object") throw TypeError(".simpleperf_report_proto.Record.file: object expected");
        message.file = $root.simpleperf_report_proto.File.fromObject(object.file);
      }
      if (object.thread != null) {
        if (typeof object.thread !== "object") throw TypeError(".simpleperf_report_proto.Record.thread: object expected");
        message.thread = $root.simpleperf_report_proto.Thread.fromObject(object.thread);
      }
      if (object.metaInfo != null) {
        if (typeof object.metaInfo !== "object") throw TypeError(".simpleperf_report_proto.Record.metaInfo: object expected");
        message.metaInfo = $root.simpleperf_report_proto.MetaInfo.fromObject(object.metaInfo);
      }
      if (object.contextSwitch != null) {
        if (typeof object.contextSwitch !== "object") throw TypeError(".simpleperf_report_proto.Record.contextSwitch: object expected");
...
/* harmony export */   SimpleperfReportConverter: () => (/* binding */ SimpleperfReportConverter),
/* harmony export */   convertSimpleperfTraceProfile: () => (/* binding */ convertSimpleperfTraceProfile)
/* harmony export */ });
/* harmony import */ var core_js_modules_esnext_iterator_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/esnext.iterator.for-each.js */ "./node_modules/core-js/modules/esnext.iterator.for-each.js");
...
/* harmony import */ var _proto_simpleperf_report__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./proto/simpleperf_report */ "./src/profile-logic/import/proto/simpleperf_report.js");
/* harmony import */ var _proto_simpleperf_report__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_proto_simpleperf_report__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _app_logic_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../app-logic/constants */ "./src/app-logic/constants.ts");
/* harmony import */ var _data_structures__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../data-structures */ "./src/profile-logic/data-structures.ts");
/* harmony import */ var _utils_string_table__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/string-table */ "./src/utils/string-table.ts");
/* harmony import */ var _utils_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils/types */ "./src/utils/types.ts");
/* harmony import */ var _utils_magic__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../utils/magic */ "./src/utils/magic.ts");
/* harmony import */ var long__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! long */ "./node_modules/long/index.js");
var _Categories;
...
function toNumber(value) {
  if (long__WEBPACK_IMPORTED_MODULE_8__["default"].isLong(value)) {
...
class Categories {
  ...
  static createCategory(name, color) {
...
Categories.Other = _Categories.createCategory('Other', 'grey');
Categories.Native = _Categories.createCategory('Native', 'magenta');
Categories.Java = _Categories.createCategory('Java', 'green');
Categories.System = _Categories.createCategory('System', 'yellow');
Categories.Kernel = _Categories.createCategory('Kernel', 'orange');
class FirefoxResourceTable {
  constructor(strings) {
    this.strings = void 0;
    this.resourceTable = (0,_data_structures__WEBPACK_IMPORTED_MODULE_4__.getEmptyResourceTable)();
...
class FirefoxFuncTable {
  constructor(strings) {
    this.strings = void 0;
    this.funcTable = (0,_data_structures__WEBPACK_IMPORTED_MODULE_4__.getEmptyFuncTable)();
  ...
  findOrAddFunc(name, resourceIndex) {
...
class FirefoxFrameTable {
  constructor(strings) {
    this.strings = void 0;
    this.frameTable = (0,_data_structures__WEBPACK_IMPORTED_MODULE_4__.getEmptyFrameTable)();
  ...
  findOrAddFrame(funcIndex, category) {
...
class FirefoxSampleTable {
  constructor(strings) {
    this.strings = void 0;
    this.stackTable = (0,_data_structures__WEBPACK_IMPORTED_MODULE_4__.getEmptyRawStackTable)();
  ...
  findOrAddStack(frameIndex, prefix) {
...
class FirefoxThread {
  constructor(thread, stringTable) {
    this.name = void 0;
    this.isMainThread = void 0;
    this.tid = void 0;
    this.pid = void 0;
    this.strings = void 0;
    this.sampleTable = (0,_data_structures__WEBPACK_IMPORTED_MODULE_4__.getEmptySamplesTable)();
    this.stackTable = void 0;
    this.frameTable = void 0;
    this.funcTable = void 0;
    this.resourceTable = void 0;
    this.cpuClockEventId = -1;
  ...
  toJson() {
    return {
      ...
      markers: (0,_data_structures__WEBPACK_IMPORTED_MODULE_4__.getEmptyRawMarkerTable)(),
      ...
      nativeSymbols: (0,_data_structures__WEBPACK_IMPORTED_MODULE_4__.getEmptyNativeSymbolTable)()
    };
  }
  enableCpuClock(cpuClockEventId) {
  ...
  addSample(sample, fileMap) {
    let prefixStackId = null;
    for (const frame of sample.callchain.reverse()) {
      ...
      } else if (filePath === '[JIT app cache]' || filePath.endsWith('.vdex') || filePath.endsWith('.apk') || filePath.endsWith('.jar') || filePath.endsWith('.oat') || filePath.endsWith('.odex')) {
    ...
    (0,_utils_types__WEBPACK_IMPORTED_MODULE_6__.ensureExists)(this.sampleTable.time).push(toMilliseconds(sample.time ?? 0));
...
class FirefoxProfile {
  constructor() {
    ...
    this.lostCount = 0;
    this.stringArray = [];
    this.stringTable = _utils_string_table__WEBPACK_IMPORTED_MODULE_5__.StringTable.withBackingArray(this.stringArray);
  }
  toJson() {
    return {
      ...
      shared: {
        ...
        sources: (0,_data_structures__WEBPACK_IMPORTED_MODULE_4__.getEmptySourceTable)()
      },
  ...
  getProfileMeta() {
    return {
      ...
      preprocessedProfileVersion: _app_logic_constants__WEBPACK_IMPORTED_MODULE_3__.PROCESSED_PROFILE_VERSION,
  ...
  setMetaInfo(metaInfo) {
    ...
    this.cpuClockEventId = (this.eventTypes && this.eventTypes.indexOf('cpu-clock')) ?? -1;
  }
  setLostSituation(lost) {
...
class SimpleperfReportConverter {
  ...
  readMagic() {
    if (!(0,_utils_magic__WEBPACK_IMPORTED_MODULE_7__.verifyMagic)(_utils_magic__WEBPACK_IMPORTED_MODULE_7__.SIMPLEPERF, this.buffer)) {
      throw new Error('Invalid simpleperf file');
    }
    this.bufferOffset += _utils_magic__WEBPACK_IMPORTED_MODULE_7__.SIMPLEPERF.length;
  }
  readRecord(recordSize) {
    ...
    return _proto_simpleperf_report__WEBPACK_IMPORTED_MODULE_2__.simpleperf_report_proto.Record.decode(recordArray);
  }
  process() {
    this.readMagic();
    ...
    let sampleCount = 0;
    while (recordSize > 0) {
      const record = this.readRecord(recordSize);
...
function convertSimpleperfTraceProfile(traceBuffer) {
...
//# sourceMappingURL=src_profile-logic_import_simpleperf_ts.8a95857e9d345213959d.bundle.js.map